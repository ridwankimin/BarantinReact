  ...
  return (
    ...
    <h4 className="py-3 breadcrumb-wrapper mb-4">
        ...
        <small className='float-end'>
            <span className='text-danger'>{(data.errorPTK ? data.errorPTK + "; " : "") + (data.errorKomoditas ? data.errorKomoditas + "; " : "") + (data.errork92i ? data.errork92i + "; " : "") + (data.errorSurtug ? data.errorSurtug + "; " : "")}</span>
            {data.errorPTK || data.errorKomoditas || data.errork92i || data.errorSurtug ?
