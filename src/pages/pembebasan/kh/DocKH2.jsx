            ...
            <div className="card mb-4">
                ...
                <form className="card-body">
                    <div className="row mb-3">
                        <label className="col-sm-2 col-form-label" htmlFor="nomor_kh2">Nomor KH-2</label>
                        <div className="col-sm-3">
                            <input type="text" id="nomor_kh2" className="form-control form-control-sm" placeholder="Nomor KH-2" disabled />
                        </div>
                        <label className="col-sm-1 col-form-label" htmlFor="tanggal_kh2">Tgl</label>
                        <div className="col-sm-2">
                            <input type="text" id="tanggal_kh2" className="form-control form-control-sm" placeholder="Tanggal KH-2" />
                        </div>
                    ...
                    <div className="form-check">
                        ...
                        <label className="form-check-label" htmlFor="pernyataan1">
                            Produk hewan tersebut di atas telah dilakukan tindakan, tidak ditemukan HPHK.
                        </label>
                    </div>
                    <div className="form-check">
                        <input className="form-check-input" type="checkbox" value="" id="pernyataan2" />
                        <label className="form-check-label" htmlFor="pernyataan2">
                            Produk Hewan tersebut di atas dalam keadaan sanitasi baik, kemasan utuh, tidak terjadi perubahan sifat, tidak terkontaminasi, dan dinilai tidak membahayakan kesehatan hewan dan/atau manusia.
                        </label>
                    </div>
                    <div className="form-check">
                        <input className="form-check-input" type="checkbox" value="" id="pernyataan3" />
                        <label className="form-check-label" htmlFor="pernyataan3">
                            Produk Hewan tersebut di atas telah memenuhi persyaratan dokumen lain.
                        </label>
                    </div>
                    <div className="form-check">
