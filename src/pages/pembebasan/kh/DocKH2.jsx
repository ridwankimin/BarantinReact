...
function DocKH2() {
    ...
    const {
        register: registerMPkh2,
        setValue: setValueMPkh2,
        // control: controlMPkh2,
        watch: watchMPkh2,
        handleSubmit: handleFormMPkh2,
        reset: resetFormKomoditikh2,
        formState: { errors: errorsMPkh2 },
    } = useForm({
        defaultValues: {
            idMPkh2: "",
            volumeNetto: "",
                ...
                if(response.data) {
                    if(typeof response.data != "string") {
                        if(response.data.status == 200) {
                            ...
                            setValue("idDokh2", response.data.data.id)
                            setValue("noDokh2", response.data.data.nomor)
                            setValue("tglDokh2", response.data.data.tanggal)
                            ...
                            setData(values => ({...values,
                                errorKH2: "Gagal load data Sertifikat Sanitasi Hewan"
                            }))
                        }
                    } else {
                        setData(values => ({...values,
  ...
  return (
    <div className="container-xxl flex-grow-1 container-p-y">
        <h4 className="py-3 breadcrumb-wrapper mb-4">
            KH-2 <span className="fw-light" style={{color: 'blue'}}>SERTIFIKAT SANITASI PRODUK HEWAN</span>
            
            <small className='float-end'>
                <span className='text-danger'>{(data.errorPTKPage ? data.errorPTKPage + "; " : "") + (data.errorSurtugPage ? data.errorSurtugPage + "; " : "") + (data.errorKomoditi ? data.errorKomoditi + "; " : "") + (data.errorKH2 ? data.errorKH2 + "; " : "")}</span>
                {data.errorPTK || data.errorSurtugPage || data.errorKomoditi || data.errorKH2 ?
            ...
            <div className="col-xxl">
                <div className="card card-action mb-4">
                    ...
                    <form className="card-body" onSubmit={handleSubmit(onSubmit)}>
                        <input type="hidden" id='idDokh2' {...register("idDokh2")} />
                        <input type="hidden" id='idPtk' {...register("idPtk")} />
                        <input type="hidden" id='noDokumen' {...register("noDokumen")} />
                        <div className="col-md-12 mt-3">
                            <div className="row">
                                <label className="col-sm-2 col-form-label text-sm-start" htmlFor="jenisDokumen">Status Dokumen <span className='text-danger'>*</span></label>
                        ...
                        <div className="col-md-12">
                            <div className="row mb-3">
                                <label className="col-sm-2 col-form-label text-sm-start" htmlFor="noDokh2">Nomor Dokumen</label>
                                <div className="col-sm-3">
                                    <input type="text" id="noDokh2" name='noDokh2' {...register("noDokh2")} className="form-control form-control-sm" placeholder="Nomor Dokumen KH-2" disabled />
                                </div>
            ...
            <div className="modal-dialog modal-lg">
                <div className="modal-content p-3 pb-1">
                    <div className="modal-body">
                        ...
                        <form onSubmit={handleFormMPkh2(onSubmitMPkh2)} className="row g-3">
                        <input type="hidden" name='idMPkh2' {...registerMPkh2("idMPkh2")} />
                        <input type="hidden" name='idPtk' {...registerMPkh2("idPtk")} />
                        <input type="hidden" name='jenisKar' {...registerMPkh2("jenisKar")} />
                            <div className="col-6">
                                <label className="form-label" htmlFor="namaUmum">Nama Umum Tercetak</label>
                                <input type='text' name="namaUmum" id="namaUmum" {...registerMPkh2("namaUmum")} className="form-control form-control-sm" />
                            </div>
                            <div className="col-6">
                                <label className="form-label" htmlFor="namaLatin">Nama Latin Tercetak</label>
                                <input type='text' name="namaLatin" id="namaLatin" {...registerMPkh2("namaLatin")} className="form-control form-control-sm" />
                            </div>
                            <div className="col-6">
                                ...
                                {errorsMPkh2.volumeNetto && <small className="text-danger">{errorsMPkh2.volumeNetto.message}</small>}
                            </div>
                            <div className="col-6">
                            ...
                            <div className="col-6" style={{display: (data.listPtk ? (data.listPtk.jenis_media_pembawa_id == 1 ? "block" : "none") : "none")}}>
                                ...
                                {errorsMPkh2.jantanP8 && <small className="text-danger">{errorsMPkh2.jantanP8.message}</small>}
                            </div>
                            <div className="col-6" style={{display: (data.listPtk ? (data.listPtk.jenis_media_pembawa_id == 1 ? "block" : "none") : "none")}}>
