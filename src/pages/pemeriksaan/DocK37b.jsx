...
function DocK37b() {
    ...
    function submitModKesehatan(e) {
        ...
        setListKesehatan([...listKesehatan, { 
            ...
            metode1: data.metodePeriksa,
            temuan_hasil1: data.temuanPeriksa,
            catatan1: data.catatanPeriksa,
            target_sasaran2: data.targetWasdal,
            metode2: data.metodeWasdal,
            temuan_hasil2: data.temuanWasdal,
            catatan2: data.catatanWasdal,
         }]);
