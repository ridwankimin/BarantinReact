            ...
            .then((response) => {
                ...
                if(response.data) {
                    if(response.data.status === '201') {
                        ...
                        const resHsy = log.pushHistory(data.idPtk, "p1a", "K-3.7a", (data.idDok37a ? 'put' : 'post'));
                        resHsy
                        .then((response) => {
                            if(response.data.status === '201') {
                    ...
                    {/* <div className="card"> */}
                        <div className="col-md-12 mt-3">
                            <div className="row mb-3">
                                ...
                                <div className="col-sm-3">
                                    <input type="text" id="noDok37a" {...registerAdministratif("noDok37a")} className="form-control form-control-sm" placeholder="Nomor Dokumen K-3.7" disabled />
                                </div>
