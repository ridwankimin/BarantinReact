  ...
  <br />
    ...
    <div className="container-xxl flex-grow-1 container-p-y">
        <h4 className="py-3 breadcrumb-wrapper mb-4">
            KT.1 <span className="text-muted fw-light">(PHYTOSANITARY CERTIFICATE)</span>
        </h4>
                ...
                <div className="card mb-4" >
                    ...
                    <div className="container" id="hal1" >
                        ...
                        <tr style={{height: '54px'}}>
                            <td style={{width: '49.145%', height: '54px'}} colSpan="2"><strong>PHYTOSANITARY CERTIFICATE FOR </strong><br />No :</td>
                        ...
                        <td style={{width: '99.8672%', height: '18px'}} colSpan="6">
                             <p>This is to certify that the plants, plant products or other regulated articles described herein have been inspected and/or tested according to appropriate official procedures and are considered to be free from the quarantine pests specified by the importing contracting party and to conform with the current phytosanitary requirements of the importing contracting party, including those for regulated non-quarantine pests</p>
                        </td>
                        </tr>
                        <tr style={{height: '18px'}}>
