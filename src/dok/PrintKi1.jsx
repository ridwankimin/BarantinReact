        ...
        <div className="col-xxl">
            <div className="card mb-4">
                ...
                <div className="container" id="hal1">
                    ...
                    <p style={{textAlign: 'center'}}>Ref Number:............</p>
                    ...
                    <table style={{borderCollapse: 'collapse', width: '100%'}} border="1" id="tabel">
                        <tbody>
                            ...
                            <tr>
                                <td style={{width: '5.73388%'}}>&nbsp;</td>
                                <td style={{width: '34.2661%'}}>
                                    <p>&nbsp;</p>
                                    <p>&nbsp;</p>
                                </td>
                                <td style={{width: '31.797%'}}>&nbsp;</td>
                                <td style={{width: '15.0618%'}}>&nbsp;</td>
                                <td style={{width: '13.1413%'}}>&nbsp;</td>
                            </tr>
                            <tr>
                    ...
                    <table style={{borderCollapse: 'collapse', width: '100%', height: '252px'}} border="1" id="tabel">
                        <tbody>
                            <tr style={{height: '72px'}}>
                                <td style={{width: '47.9925%', height: '72px'}} colspan="3">1. Consignor / <em>Pengirim barang</em> &nbsp; <br />Name / <em>Nama</em> :<br />Address / <em>Alamat</em> : <br />&nbsp;</td>
                                <td style={{width: '33.4431%', height: '72px'}}>2. Competent authority / <em>Otoritas </em><em>kompeten</em></td>
                            </tr>
                            <tr style={{height: '72px'}}>
                                <td style={{width: '81.4356%', height: '72px'}} colspan="4">3. Consignee / <em>Penerima barang</em> &nbsp; <br />Name / <em>Nama</em> :<br />Address / <em>Alamat</em> : <br />&nbsp;</td>
                            </tr>
                            <tr style={{height: '36px'}}>
                                <td style={{width: '81.4356%', height: '36px'}} colspan="4">4. Producing establishment/farm / <em>Pabrik Pengolahan/budidaya</em>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;Aquaculture establishment/<em>Unit Usaha Budidaya</em> <em>(UUP)</em>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;Others / <em>Lainnya</em><br />Name / Nama :<br />Establishment ID Number / No Registrasi:<br />Address (detailed) / Alamat lengkap:</td>
                            </tr>
                            ...
                            <tr style={{height: '18px'}}>
                                ...
                                <td style={{width: '47.0323%', height: '18px'}} colspan="3">7. Source / <em>Sumber</em><br />farm-raised / budidaya&nbsp; wild-caught / <em>tangkap</em></td>
                            </tr>
                            <tr style={{height: '18px'}}>
                                <td style={{width: '34.4033%', height: '18px'}}>8. Port of shipment / <em>pelabuhan pengeluaran:</em></td>
                                <td style={{width: '47.0323%', height: '18px'}} colspan="3">9. Means of transport / <em>Alat transportasi:</em><br />aeroplane/Angkutan udara Ship/Angkutan laut road vehicle/Angkutan darat</td>
                            </tr>
                            <tr style={{height: '18px'}}>
                                <td style={{width: '40.5487%', height: '18px'}} colspan="2">10. Description of commodity / <em>Deskripsi komoditas:</em></td>
                                <td style={{width: '40.8869%', height: '18px'}} colspan="2">Temperature of the commodity / <em>Temperatur komoditas:</em><br />ambient (live) / frozen / beku chilled / dingin ruang (hidup)</td>
                            </tr>
                            <tr>
                                <td style={{width: '40.5487%'}} colspan="2">12.Commodities intended for uses as / <em>Komodita</em><em>s </em><em>d</em><em>iperuntukkan sebagai:</em><br />
                                    <p>Human consumption / <em>Konsumsi manusia</em></p>
                                    <p>Culture/breeding (broodstock, eggs, gametes) / <em>Budidaya/pembenihan</em></p>
                                    <p>Ornamental <em>/ Ikan hias</em></p>
                                    <p>Research &amp; Investigation / <em>Penelitian&nbsp; &amp; pemeriksaan</em></p>
                                    <p>Aquatic animal feed / baits / <em>Pakan &nbsp;/ umpan pancing</em></p>
                                    Non edible (fish skin, shell, bones, etc) / <em>Non konsumsi</em>
                                </td>
                            ...
                            <tr>
                                <td style={{width: '40.5487%'}} colspan="2">14. Type of packaging <em>/ Jenis kemasan:</em></td>
                        ...
                        <tbody>
                            <tr>
                                <td style={{width: '99.8596%'}} colspan="2" width="671">
                                    ...
                                    <p>to be free from diseases / <em>bebas dari penyakit</em> :&nbsp; &nbsp; &nbsp; &nbsp;</p>
                                    <p>to show no visible/clinical &nbsp;signs of diseases / <em>tidak menunjukkan gejala penyakit secara &nbsp;visual/klinis :</em> &nbsp;</p>
                                    <ol style={{listStyleType: 'lower-alpha'}}>
                                        <li>For non edible products have been handled, prepared or processed, stored, transported based on &nbsp;biosecurity principles / <em>produk non konsumsi telah ditangani, disiapkan atau diproses, disimpan, ditransportasikan berdasarkan prinsip biosekuriti</em></li>
                                        <li>Other details/ <em>keterangan</em> <em>lainnya </em>.............</li>
                                    </ol>
                                    <p>&nbsp;</p>
                                </td>
                            </tr>
                            <tr>
                                <td style={{width: '99.8596%'}} colspan="2">
                                    <p>Additional information / <em>Informasi tambahan:</em></p>
                                    <p>&nbsp;</p>
                                    <p>&nbsp;</p>
                                </td>
                            </tr>
                            ...
                            <tr>
                                <td style={{width: '49.9298%'}}>Name / <em>Nama:</em></td>
                            </tr>
                            <tr>
                                <td style={{width: '49.9298%'}}>Position / <em>Jabatan :</em></td>
                            </tr>
                            <tr>
                                <td style={{width: '49.9298%'}}>Issued at / <em>Lokasi :</em></td>
                            </tr>
                            <tr>
